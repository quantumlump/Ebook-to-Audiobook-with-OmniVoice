  ...
  run: [
    // windows nvidia
    {
      ...
      "params": {
        ...
        "path": "{{args && args.path ? args.path : '.'}}",
          ...
          "{{args && args.triton ? 'uv pip install -U triton-windows' : 'true'}}",
          "{{args && args.sageattention ? 'uv pip install https://github.com/woct0rdho/SageAttention/releases/download/v2.1.1-windows/sageattention-2.1.1+cu128torch2.7.0-cp310-cp310-win_amd64.whl' : 'true'}}",
        ]
      },
      "next": null
    },
    ...
    // linux nvidia
    {
      ...
      "params": {
        ...
        "message": [
          "uv pip install torch==2.7.0 torchvision==0.22.0 torchaudio==2.7.0 {{args && args.xformers ? 'xformers' : ''}} --index-url https://download.pytorch.org/whl/cu128",
          "{{args && args.sageattention ? 'uv pip install git+https://github.com/thu-ml/SageAttention.git' : 'true'}}"
        ]
      },
      "next": null
    },
